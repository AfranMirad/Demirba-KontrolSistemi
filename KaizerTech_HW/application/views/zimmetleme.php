          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <div class="container-fluid">
                  ...
                  <form role="form" method="post" action="<?php echo base_url('user/getzimmetAdd'); ?>">
                  </br>
                    <div class="col">

                    <div class="col">

                      Personelinizi seçiniz  : <select name="personel_id">

                          <?php

                          foreach ($personel as $row) {

                          ?><option value="<?php echo $row->personel_id;?>"><?php echo $row->personel_adi;?></option><?php
                          }
                           ?>
                        </select>
                      </br>
                    ...
                    <div class="col">
                        ...
                        Ürüününüzü giriniz  :    <select name="urun_id">
                   ...
                   <button type="submit" class="btn btn-outline-primary">Zimmetle</button>
