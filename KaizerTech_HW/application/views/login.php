			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" role="form" method="post" action="<?php echo base_url('user/login_user'); ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="user_email" placeholder="Email" maxlength="30">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="user_password"  placeholder="Parola" maxlength="30" >
						<span class="focus-input100"></span>
						<span class="symbol-input100">
